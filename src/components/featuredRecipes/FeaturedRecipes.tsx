      ...
      <div className="flex flex-col lg:flex-row gap-10 mx-5 sm:mx-10 md:mx-20 lg:mx-32 justify-center lg:justify-between mt-10">
        ...
        <div className="flex flex-col gap-10 items-center">
          {res.map((item: Recipe, index: number) => (
            <div
              key={index}
              className="w-full xsm:w-[280px] sm:w-[320px] md:w-[360px] lg:w-[400px] h-auto border-2 border-[#7C4EE4] pb-4 rounded-lg hover:scale-105 transition-all duration-1000 ease-in-out"
            >
              {/* Top Image */}
